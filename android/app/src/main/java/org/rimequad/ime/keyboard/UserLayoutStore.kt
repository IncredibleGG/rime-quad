 ...
 * [org.rimequad.ime.store.InstalledRegistry] 的 `rimequad-store.json`、
 * [org.rimequad.ime.store.BuiltinMigration] 的 `builtin_introduced.json` 同區。
 *
 ...
 *
 * ── 執行緒 ──────────────────────────────────────────────────────────────
 * IME 服務與設定畫面在同一個行程（見 [org.rimequad.ime.prefs.PrefsStore] 的
 ...
 * [org.rimequad.ime.store.InstalledRegistry] 同一個作法，理由見那裡。
 */
