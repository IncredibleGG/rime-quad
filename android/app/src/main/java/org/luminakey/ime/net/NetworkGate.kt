 ...
 * （[org.luminakey.ime.store.StoreController] 與
 *  [org.luminakey.ime.update.UpdateController] 各有一條 worker）。
...
object NetworkGate {
     ...
     *
     * 原本送的是舊名 `rimequad-android`。在有審查的網路環境下那一行就足以讓
     ...
     * 抽出來之後 [org.luminakey.ime.net.NetworkRedirectTest] 可以直接對它下
