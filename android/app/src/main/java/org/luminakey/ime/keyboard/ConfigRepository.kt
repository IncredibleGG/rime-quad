...
import org.luminakey.ime.DiagnosticStrings
import org.luminakey.ime.core.RimeRuntime
import org.luminakey.ime.theme.ChainedDocumentSource
import org.luminakey.ime.theme.Diagnostic
import org.luminakey.ime.theme.DiagnosticText
import org.luminakey.ime.theme.DocumentSource
...
import org.luminakey.ime.theme.MapDocumentSource
...
class ConfigRepository(context: Context) : LayoutRepository {
    ...
    companion object {
         ...
         * / `zh-Hans` 各一份），[org.luminakey.ime.theme.LocalizedString.get] 也
