 ...
 * [org.rimequad.ime.keyboard.LayoutEscapeTest] 與 `verify_rime_compose.sh` 的事。
 *
 * ── 它抓不到什麼(誠實說明) ─────────────────────────────────────────────
...
class DeadKeyTest {
     ...
     * 而且本專案已有先例([org.rimequad.ime.StringCatalogTest] 直接讀 res)。
     *
    ...
    private fun serviceSource(): String {
        val f = File(
            ...
            "android/app/src/main/java/org/rimequad/ime/RimeInputMethodService.kt",
        )
