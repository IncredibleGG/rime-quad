...
import org.luminakey.ime.keyboard.LayoutRemapValidator
 ...
 *
 *  · 全部邏輯都在 `org.luminakey.ime.keyboard`（純函式 + 儲存層），
 ...
 *
 * ── 為什麼驗證要放到背景執行緒 ──────────────────────────────────────────
 * [LayoutRemapValidator] 會跑逃生不變式的圖走訪（[org.luminakey.ime.keyboard.LayoutEscape]），
